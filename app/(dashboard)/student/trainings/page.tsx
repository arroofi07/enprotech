...
type StudentTrainingsPageProps = {
...
export default async function StudentTrainingsPage({
  ...
  return (
    <>
      <StudentHeader
        title="Training Saya"
        breadcrumbs={[{ label: "Training Saya" }]}
      />
      <main className="flex-1 overflow-auto">
        <div className="container max-w-7xl min-w-0 space-y-6 p-4 sm:p-6 md:p-8">
          <AdminPageHeader
            title="Training Saya"
            description="Pilih training untuk melihat detail progress dan mengakses materi pembelajaran."
            actions={
