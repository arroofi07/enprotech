...
const PAGE_SIZE = 10;
const BASE_PATH = "/trainer/bobot-soal";

type TrainerQuestionWeightHubPageProps = {
  searchParams?: {
    page?: string;
    search?: string;
    status?: string;
...
export async function TrainerQuestionWeightHubPage({
  searchParams = {},
}: TrainerQuestionWeightHubPageProps) {
      ...
      <main className="flex-1 overflow-auto">
        <div className="container max-w-7xl space-y-6 p-6 md:p-8">
          <AdminPageHeader
            ...
            description="Pilih training untuk mengatur nilai per soal pada pre-test, post-test, quiz, dan latihan."
          />
                    ...
                    },
                    {
                      ...
                      cell: (training) => (
                        <ButtonLink
                          variant="outline"
                          size="sm"
                          href={`/trainer/trainings/${training.id}/bobot-soal`}
                        >
                          Kelola Bobot
                        </ButtonLink>
                      ),
